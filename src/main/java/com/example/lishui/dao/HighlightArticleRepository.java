...
public interface HighlightArticleRepository extends JpaRepository<HighlightArticle,Long> {
    ...
    Page<HighlightArticle> findAllByTitleOrUsername(@Param("search") String search, Pageable p);
    ...
    Page<HighlightArticle> findAllByCreateAtBetween(@DateTimeFormat(pattern = "yyyy-MM-dd") @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd") Date start,

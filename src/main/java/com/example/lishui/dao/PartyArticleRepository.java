...
public interface PartyArticleRepository extends JpaRepository<PartyArticle,Long> {
    ...
    Page<PartyArticle> findAllByTitleOrUsername(@Param("search") String search, Pageable p);
    ...
    Page<PartyArticle> findAllByCreateAtBetween(@DateTimeFormat(pattern = "yyyy-MM-dd") @JsonFormat(timezone = "GMT+8", pattern = "yyyy-MM-dd") Date start,
